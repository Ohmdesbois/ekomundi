...
function ekoviewfilterAttach(context) {

  if($('#edit-action-filter').is(':visible')) {
    convertSelectElement($('#edit-action-filter'));
  }
...
Drupal.behaviors.ekoviewfilter = {
  attach: function(context){
    ekoviewfilterAttach(context);
  }
}
